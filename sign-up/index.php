...
<head>
    ...
    <title>Animazooki | Sign Up</title>
</head>
        ...
        <main class="w100 clflx">
              ...
              <form class="animazooki-sign-up-cont txtl bg-light-in">
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="form3Example1cg" class="form-control form-control" placeholder="Enter Name"/>
                </div>

                <div class="form-outline mb-4">
                  <input type="email" id="form3Example3cg" class="form-control form-control" placeholder="Enter Email"/>
                </div>

                <div class="form-outline mb-4">
                  <input type="password" id="form3Example4cg" class="form-control form-control"  placeholder="Enter Password"/>
                </div>

                <div class="form-outline mb-4">
                  <input type="password" id="form3Example4cdg" class="form-control form-control"  placeholder="Re-enter Password"/>
                </div>


                <div class="d-flex justify-content-center">
                  <button type="button"
                    class="inbg-red txt-light btn btn-success btn-block btn-lg gradient-custom-4 text-body rwflx txtc"><a class="txt-light" href="https://sceiiya.wd49p.com/animazooki/">Create Account</a></button>
                </div>
                ...
                <div class="form-check d-flex justify-content-center mt-3 mb-0">
                    ...
                    <label class="form-check-label cb-sgn-txt" for="form2Example3g">
                      I agree to all statements in <a href="#!" class="text-body" onclick="popdev()"><u>Terms of service</u></a>
                    </label>
                  </div>

                <p class="text-center text-muted mb-0">Already have an account? <a href="https://sceiiya.wd49p.com/animazooki/log-in/"
