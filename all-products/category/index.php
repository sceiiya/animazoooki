...
<head>
    ...
    <title>Animazooki | All Categories</title>
</head>
        ...
        <main class="main">
                    ...
                    <div class="card-cont-attr">
                        ...
                        <a class="card-attr">
                            <div class="category-img-cont">
                                <img src="/animazooki/all-products/category/mock/1.jpg" class="series-img-main" alt="...">
                            </div>
                        ...
                        <a class="card-attr">
                            <div class="category-img-cont">
                                <img src="/animazooki/all-products/category/mock/2.jpg" class="series-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="category-name-cont">
                                    <p class="category-name txt-light">
                        ...
                        <a class="card-attr">
                            <div class="category-img-cont">
                                <img src="/animazooki/all-products/category/mock/3.jpg" class="series-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="category-name-cont">
                                    <p class="category-name txt-light">
                        ...
                        <a class="card-attr">
                            <div class="category-img-cont">
                                <img src="/animazooki/all-products/category/mock/4.jpg" class="series-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="category-name-cont">
                                    <p class="category-name txt-light">
                        ...
                        <a class="card-attr">
                            <div class="category-img-cont">
                                <img src="/animazooki/all-products/category/mock/5.jpg" class="series-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="category-name-cont">
                                    <p class="category-name txt-light">
                        ...
                        <a class="card-attr">
                            <div class="category-img-cont">
                                <img src="/animazooki/all-products/category/mock/6.jpg" class="series-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="category-name-cont">
                                    <p class="category-name txt-light">
            ...
            <section class="content-cards-container">
                <div class="card-cont-attr">
                    ...
                    <a class="card-attr">
                        <div class="category-img-cont">
                            <img src="/animazooki/all-products/category/mock/7.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="category-name-cont">
                                <p class="category-name txt-light">
                    ...
                    <a class="card-attr">
                        <div class="category-img-cont">
                            <img src="/animazooki/all-products/category/mock/8.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="category-name-cont">
                                <p class="category-name txt-light">
                    ...
                    <a class="card-attr">
                        <div class="category-img-cont">
                            <img src="/animazooki/all-products/category/mock/9.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="category-name-cont">
                                <p class="category-name txt-light">
                    ...
                    <a class="card-attr">
                        <div class="category-img-cont">
                            <img src="/animazooki/all-products/category/mock/10.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="category-name-cont">
                                <p class="category-name txt-light">
                    ...
                    <a class="card-attr">
                        <div class="category-img-cont">
                            <img src="/animazooki/all-products/category/mock/11.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="category-name-cont">
                                <p class="category-name txt-light">
                    ...
                    <a class="card-attr">
                        <div class="category-img-cont">
                            <img src="/animazooki/all-products/category/mock/12.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="category-name-cont">
                                <p class="category-name txt-light">
