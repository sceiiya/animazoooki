...
<head>
    ...
    <title>Enna Alouette T-shirt | Animazooki Merch Co.</title>
</head>
    ...
    <section class="wrapper">
        ...
        <main class="ind-product-cont">
            ...
            <div class="product-main-inf">
                <div class="product-imgs-cont">
                    <div class="product-img-cont">
                        <img class="product-img-main" src="/animazooki/all-products/Enna-Alouette_t-shirt/1.jpg"
                            alt="">
                    </div>
                    <div class="product-img-sub-cont-holder">
                        <div class="product-img-sub-cont">
                            <img class="product-img-sub" src="/animazooki/all-products/Enna-Alouette_t-shirt/1.jpg"
                                alt="">
                        </div>
                        <div class="product-img-sub-cont">
                            <img class="product-img-sub" src="/animazooki/all-products/Enna-Alouette_t-shirt/2.jpg"
                                alt="">
                        </div>
                        <div class="product-img-sub-cont">
                            <img class="product-img-sub" src="/animazooki/all-products/Enna-Alouette_t-shirt/3.jpg"
                                alt="">
                        </div>
                        <div class="product-img-sub-cont">
                            <img class="product-img-sub" src="/animazooki/all-products/Enna-Alouette_t-shirt/4.jpg"
                                alt="">
                        </div>
                    </div>
                </div>
                <div class="product-inf-cont">
                    ...
                    <div class="product-headinf-cont my-1">
                        ...
                        <div class="product-rating-cont txtc">
                            ...
                            <i class="fas fa-star rated"></i>
                            <i class="fas fa-star rated"></i>
                            &nbsp;&nbsp;|&nbsp;&nbsp; <em class="product-rating-count">999 reviews</em>
                        </div>
                    </div>
            ...
            <div class="product-desc txtl pt-3 ps-2">
                Product Name: Enna Alouette NIJISANJI EN inspired T-shirt<br/><br/>

                Series: ANYCOLOR Inc.<br/>
                ...
                <br/>
                “Your unhinged songbird from hell”<br/>
                <br/><br/>
