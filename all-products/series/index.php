        ...
        <main class="main">
                ...
                <div class="card-cont-attr">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/1.jpg" class="series-img-main" alt="...">
                        </div>
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/2.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/3.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/4.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/5.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/6.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
            ...
            <section class="content-cards-container">
                <div class="card-cont-attr">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/7.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/8.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/9.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/10.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/11.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/12.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
            ...
            <section class="content-cards-container">
                <div class="card-cont-attr">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/13.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/14.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
                    ...
                    <a class="card-attr">
                        <div class="series-img-cont">
                            <img src="/animazooki/all-products/series/mock/15.jpg" class="series-img-main" alt="...">
                        </div>
                        <div class=" item-inf-cont">
                            <div class="series-name-cont">
                                <p class="series-name">
