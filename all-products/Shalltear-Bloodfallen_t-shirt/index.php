...
<head>
    ...
    <title>Shalltear Bloodfallen T-Shirt | Animazooki Merch Co.</title>
</head>
    ...
    <section class="wrapper">
        ...
        <main class="ind-product-cont">
            ...
            <div class="product-main-inf">
                <div class="product-imgs-cont">
                    <div class="product-img-cont">
                        <img class="product-img-main" src="/animazooki/all-products/Shalltear-Bloodfallen_t-shirt/1.jpg"
                            alt="">
                    </div>
                    <div class="product-img-sub-cont-holder">
                        <div class="product-img-sub-cont">
                            <img class="product-img-sub" src="/animazooki/all-products/Shalltear-Bloodfallen_t-shirt/1.jpg"
                                alt="">
                        </div>
                        <div class="product-img-sub-cont">
                            <img class="product-img-sub" src="/animazooki/all-products/Shalltear-Bloodfallen_t-shirt/2.jpg"
                                alt="">
                        </div>
                        <div class="product-img-sub-cont">
                            <img class="product-img-sub" src="/animazooki/all-products/Shalltear-Bloodfallen_t-shirt/3.jpg"
                                alt="">
                        </div>
                        <div class="product-img-sub-cont">
                            <img class="product-img-sub" src="/animazooki/all-products/Shalltear-Bloodfallen_t-shirt/4.jpg"
                                alt="">
                        </div>
                    </div>
                </div>
                <div class="product-inf-cont">
                    ...
                    <div class="product-headinf-cont my-1">
                        ...
                        <div class="product-rating-cont txtc">
                            ...
                            &nbsp;&nbsp;|&nbsp;&nbsp; <em class="product-rating-count">432 reviews</em>
                        </div>
                    </div>
            ...
            <div class="product-desc txtl pt-3 ps-2">
                Product Name: Shalltear Bloodfallen OVERLORD Anime Series inspired T-shirt<br/><br/>
                ...
                <br/>— Shalltear's Introduction<br/>
                <br/><br/>
