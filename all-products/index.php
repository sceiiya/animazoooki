            ...
            <section class="my-hero-home">
                ...
                <section class="content-cards-container">
                    <div class="card-cont-attr">
                        ...
                        <a class="card-attr" href="https://sceiiya.wd49p.com/animazooki/all-products/Usada-Pekora_t-shirt/">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/Usada-Pekora_t-shirt/1.jpg" class="item-img-main" alt="...">
                            </div>
                        ...
                        <a class="card-attr" href="https://sceiiya.wd49p.com/animazooki/all-products/minato-aqua-scale-figurine/">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/minato-aqua-scale-figurine/2.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                        ...
                        <a class="card-attr" href="https://sceiiya.wd49p.com/animazooki/all-products/Enna-Alouette_t-shirt/">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/Enna-Alouette_t-shirt/3.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                        ...
                        <a class="card-attr" href="https://sceiiya.wd49p.com/animazooki/all-products/Shalltear-Bloodfallen_t-shirt/">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/Shalltear-Bloodfallen_t-shirt/3.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                        ...
                        <a class="card-attr" href="">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/mock/1.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                                        Eris Boreas Greyrat MUSHOKU TENSEI Anime Series inspired T-shirt
                                    </p>
                                </div>
                                <div class="item-inf-tex-cont mb-0 pt-0">
                                    <p class="item-price">$69</p>
                        ...
                        <a class="card-attr" href="">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/mock/2.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                                        Roxy Migurdia MUSHOKU TENSEI Anime Series inspired T-shirt
                                    </p>
                                </div>
                                <div class="item-inf-tex-cont mb-0 pt-0">
                                    <p class="item-price">$69</p>
            ...
            <section class="my-hero-home">
                ...
                <section class="content-cards-container">
                    <div class="card-cont-attr">
                        ...
                        <a class="card-attr" href="">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/mock/3.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                                        Rudeus Greyrat MUSHOKU TENSEI Anime Series inspired T-shirt
                                    </p>
                                </div>
                                <div class="item-inf-tex-cont mb-0 pt-0">
                                    <p class="item-price">$69</p>
                        ...
                        <a class="card-attr" href="">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/mock/4.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                                        Rimuru Tempest TENSURA Anime Series inspired T-shirt
                                    </p>
                                </div>
                                <div class="item-inf-tex-cont mb-0 pt-0">
                                    <p class="item-price">$69</p>
                        ...
                        <a class="card-attr" href="">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/mock/5.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                                        Yor x Anya x Loid SPY X FAMILY Anime Series inspired T-shirt
                                    </p>
                                </div>
                                <div class="item-inf-tex-cont mb-0 pt-0">
                                    <p class="item-price">$69</p>
                        ...
                        <a class="card-attr" href="">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/mock/6.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                                        Suzuha Amane STEINS GATE Anime Series inspired T-shirt
                                    </p>
                                </div>
                                <div class="item-inf-tex-cont mb-0 pt-0">
                                    <p class="item-price">$69</p>
                        ...
                        <a class="card-attr" href="">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/mock/7.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                                        Nobara Kugisaki JUJUTSU KAISEN Anime Series inspired T-shirt
                                    </p>
                                </div>
                                <div class="item-inf-tex-cont mb-0 pt-0">
                                    <p class="item-price">$69</p>
                        ...
                        <a class="card-attr" href="">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/mock/8.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                                        Zero Two DARLING IN FRANXX Anime Series inspired T-shirt
                                    </p>
                                </div>
                                <div class="item-inf-tex-cont mb-0 pt-0">
                                    <p class="item-price">$69</p>
            ...
            <section class="my-hero-home">
                ...
                <section class="content-cards-container">
                    <div class="card-cont-attr">
                        ...
                        <a class="card-attr" href="">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/mock/9.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                                        Milim Nava TENSURA Anime Series inspired T-shirt
                                    </p>
                                </div>
                                <div class="item-inf-tex-cont mb-0 pt-0">
                                    <p class="item-price">$69</p>
                        ...
                        <a class="card-attr" href="">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/mock/10.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                                        Cid Kagenou EMINENCE IN SHADOW Anime Series inspired T-shirt
                                    </p>
                                </div>
                                <div class="item-inf-tex-cont mb-0 pt-0">
                                    <p class="item-price">$69</p>
                        ...
                        <a class="card-attr" href="">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/mock/11.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                                        Kurumi Tokisaki DATE A LIVE Anime Series inspired T-shirt
                                    </p>
                                </div>
                                <div class="item-inf-tex-cont mb-0 pt-0">
                                    <p class="item-price">$69</p>
                        ...
                        <a class="card-attr" href="">
                            <div class="item-img-cont">
                                <img src="/animazooki/all-products/mock/12.jpg" class="item-img-main" alt="...">
                            </div>
                            <div class=" item-inf-cont">
                                <div class="item-inf-tex-cont">
                                    <p class="item-name txt-light-inv">
                                        Ainz Ooal Gown OVERLORD Anime Series inspired T-shirt
                                    </p>
                                </div>
                                <div class="item-inf-tex-cont mb-0 pt-0">
                                    <p class="item-price">$69</p>
