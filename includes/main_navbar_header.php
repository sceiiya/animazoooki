                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-light-in">
                            <li><a class="dropdown-item txt-light-invb" href="/all-products/category/">Category</a></li>
                            <li><a class="dropdown-item txt-light-invb" href="/all-products/series/">Series</a></li>
                            <li><a class="dropdown-item txt-light-invb" href="#" onclick="popdev()">Trend</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
