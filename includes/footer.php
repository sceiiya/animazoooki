<footer class="p-0 m-0 bg-cloud">
            ...
            <div class="in-footer-mail">
                ...
                <div class="w100 txtc rwflx">
                    ...
                    <div class="in-footer-mailinput">
                        <input class="crnrclean" type="email" id="Az_join_emaillist" name="email" placeholder="tanya@gmail.com"
                            style="width: auto;">
                    </div>
        ...
        <div class="in-footer-links clflx w100 txtc my-3">
                ...
                <div class="footer-links-list rwflx txtc foot-txt">
                    ...
                    <a class="footer_cs_list_i txt-light mx-2" href="" onclick="popdev()">News</a>
                    <a class="footer_cs_list_i txt-light mx-2" href="/legal/about_us.php">More about Animazoooki</a>
        ...
        <div class="footer-copyright txtc py-1 px-4 footer-box txt-light">
            ...
            <br />
            <h6 class="author">&nbsp;Designed and Developed by Jayfourth and Sceiiya</h6>
        </div>
    </footer>