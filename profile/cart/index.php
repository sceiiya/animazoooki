                ...
                <div class="container h-100 py-5">
                    <div class="row d-flex justify-content-center align-items-center h-100">
                        <div class="col-10">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <button type="button" class="btn btn-warning btn-block btn-lg inbg-red"><a class="txt-light" href="https://sceiiya.wd49p.com/animazooki/all-products/checkout">Proceed to Pay</a></button>
                                </div>
                            </div>
