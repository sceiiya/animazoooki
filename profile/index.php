            ...
            <div class="container pt-5 w-75 bg-light-in" id="dataField">
                ...
                <form action="">
                    ...
                    <div class="mb-3 w-75 profile-data">
                        ...
                        <input type="text" class="form-control" id="contactNo" placeholder="House No., Street Name, City, Country">
                    </div>
                    <div class="mb-3 w-75 profile-data">
                        <label>Bank Account</label>
                        <input type="text" class="form-control" id="contactNo" placeholder="Bank Name">
                    </div>
