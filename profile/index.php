...
<head>
    ...
    <title>Animazooki | My Profile</title> </head>
...
<script>
  ...
  (function(d, s, id) {
    ...
    <div class="txt promo"> <div class="sliding-text-promo p-1 bg-light-inv">GET 10%-OFF VOUCHER FOR YOUR FIRST TIME ORDER | GET 10%-OFF VOUCHER FOR YOUR FIRST TIME ORDER | GET 10%-OFF VOUCHER FOR YOUR FIRST TIME ORDER | GET 10%-OFF VOUCHER FOR YOUR FIRST TIME ORDER | GET 10%-OFF VOUCHER FOR YOUR FIRST TIME ORDER | GET 10%-OFF VOUCHER FOR YOUR FIRST TIME ORDER | GET 10%-OFF VOUCHER FOR YOUR FIRST TIME ORDER | GET 10%-OFF VOUCHER FOR YOUR FIRST TIME ORDER | GET 10%-OFF VOUCHER FOR YOUR FIRST TIME ORDER | GET 10%-OFF VOUCHER FOR YOUR FIRST TIME ORDER | </div> </div>

    <div class="sticky-top navic-cont-log ic-l"></div>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top bg-light-in" style="top:29px; position: fixed !important; width: 100%;">
    ...
    <section class="profile-cont">
        ...
        <div class="profile-cont-l bg-light-in">
            <div class="clflx txtc">
                <img class="profile-img" src="/animazooki/assets/img/sceiiya-pro.png" alt="Sceiiya">
